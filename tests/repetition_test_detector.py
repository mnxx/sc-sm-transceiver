...
# Commands to be run.
#commands = [
    #"python3 test_scheme.py 2 4 2 10000",
    #"python3 test_scheme.py 2 4 4 10000",
    #"python3 test_scheme.py  4 16 10000",
    #"python3 test_unfiltered.py 128 4 1",
    #"python3 test_unfiltered.py 1024 4 1",
#]
# Run in parallel.
...
# Commands to be run.
#commands = [
#    "python3 test_scheme.py 1 1024 2 500",
#    "python3 test_scheme.py 1 1024 4 500",
#    "python3 test_scheme.py 2 1024 2 500",
#    "python3 test_scheme.py 2 1024 4 500",
#]
# Run in parallel.
#processes = [subprocess.Popen(cmd, shell=True) for cmd in commands]
# Wait until all processes have finished.
...
commands = [
    "python3 test_unfiltered.py 128 4 1",
    "python3 test_unfiltered.py 128 4 2",
    "python3 test_unfiltered.py 128 4 3",
    "python3 test_unfiltered.py 128 4 4",
    "python3 test_unfiltered.py 128 4 5",
    "python3 test_unfiltered.py 128 4 6",
    "python3 test_unfiltered.py 128 4 7",
]
# Run in parallel.
processes = [subprocess.Popen(cmd, shell=True) for cmd in commands]
# Wait until all processes have finished.
