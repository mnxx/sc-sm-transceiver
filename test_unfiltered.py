    ...
    for step in steps:
        ...
        for realization  in range(0, nb_channels):
            ...
            for transmit_antenna in range(0, setup[0]):
                ...
                for receive_antenna in range(0, setup[1]):
                    ...
                    zone = int((y[receive_antenna].size
                                - np.mod(y[receive_antenna].size, sps)) / 2) - 20 * sps - 3
            ...
            for _ in range(0, rounds):
                ...
                rx_data_frame = np.zeros((setup[1], int(rx_data_pulse.size / setup[1] / sps)),
                                         dtype=complex)
                ...
                for receive_antenna in range(0, setup[1]):
                    ...
                    rx_data_frame[receive_antenna] = channel_estimator.sync_frame_offset(data_path,
                                                                                         samples_to_use)
